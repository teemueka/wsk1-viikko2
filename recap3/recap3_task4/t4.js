...
navigator.geolocation.getCurrentPosition((position) => {
  ...
  const tbody = document.getElementById('restaurantDetails');
  ...
  restaurants.sort((a, b) => {
    const [aLongitude, aLatitude] = a.location.coordinates;
    const [bLongitude, bLatitude] = b.location.coordinates;
